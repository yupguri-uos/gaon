...
const T: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    footerCopy: "© 2026 GAON 가온. All rights reserved.",
    ...
    phoneFile: "📄 알림장.jpg",
    phoneDone: "✅ 번역 완료!",
    phoneResult: "내일(6/15)은 급식비 납부 마감일입니다. 1인당 65,000원을 준비해 주세요.",
  ...
  en: {
    ...
    phoneResult: "Tomorrow (6/15) is the school lunch fee deadline. Please prepare ₩65,000 per student.",
  ...
  vi: {
    ...
    footerCopy: "© 2026 GAON 가온. Bảo lưu mọi quyền.",
    ...
    phoneResult: "Ngày mai (6/15) là hạn chót nộp tiền ăn trưa. Vui lòng chuẩn bị 65.000₩ mỗi học sinh.",
  ...
  zh: {
    ...
    footerCopy: "© 2026 GAON 가온. 保留所有权利。",
    ...
    phoneFile: "📄 通知单.jpg",
    phoneDone: "✅ 翻译完成！",
    phoneResult: "明天(6/15)是午餐费缴纳截止日期。请准备每人65,000韩元。",
